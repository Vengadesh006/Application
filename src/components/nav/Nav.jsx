...
export const Nav = ({ isOpen }) => {
  return (
    <div
      className={`fixed top-0 left-0 h-full w-24 flex flex-col items-center justify-between gap-5 py-2 text-[#8a8788] z-30 
    ...
    >
      ...
      <ul className="flex flex-col items-center overflow-y-scroll">
        ...
        <li className="flex flex-col items-center justify-center cursor-pointer  hover:text-[#f1f1f1] hover:bg-[#464646] hover:rounded-lg size-20">
          <FaFolderOpen className="text-[25px]" />
        ...
        <li className="flex flex-col items-center  justify-center cursor-pointer  hover:text-[#f1f1f1] hover:bg-[#464646] hover:rounded-lg size-20">
          <RiEditBoxLine className="text-[25px]" />
      ...
      <div className="flex flex-col items-center cursor-pointer">
        <MdOutlineLogout className="text-[25px]" />
